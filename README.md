...
<p align="center"><img src="docs/images/product-overview.svg" alt="知华科技董事会与公司治理系统产品概览" width="920"></p>

## 公司治理数字工作空间

董事会材料、冲突披露、表决和决议执行需要同时满足效率、保密与合规要求。

ZhuaTech Board 是知华科技（**上海如静知华信息科技有限公司**）维护的前后端分离企业应用社区源码版。产品、实施与技术服务信息请访问[知华科技官网](https://www.zhuatech.cn/)。
...
利益回避、法定人数、有效票数、赞成比例与决议门槛判定。

- 接口：`POST /api/enterprise/board/evaluate-vote`
...
- 预留 电子签章、档案系统、消息平台与治理门户 的适配器边界，不包含任何真实密钥
...
Java 工程包：`cn.zhuatech.board`。前端默认端口：`8310`。
...
SEO：董事会系统、公司治理、会议管理、电子表决、董事会决议、知华科技、上海软件开发、企业信息化、软件项目外包。
